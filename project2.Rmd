...
r1 <- postResample(pred1, obs = channelTest$shares)
...
r2 <- postResample(pred2, obs = channelTest$shares)
...
r3 <- postResample(pred3, obs = channelTest$shares)
...
r4 <- postResample(predrf, obs = channelTest$shares)
...
model_types <- c("linear model 0", "linear model 1", "Linear model 3")
model_rmse <- c(r1[[1]],r2[[1]],r3[[1]])
